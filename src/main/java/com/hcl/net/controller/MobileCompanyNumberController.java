...
import com.hcl.net.exception.ResourceInvalidException;
...
public class MobileCompanyNumberController {
	...
	public CustomerAppResponse<?> addMobileNumberWithSimDetail(
			 @RequestBody MobileNoSimRegistration mobileNoSimRegistration) {
		...
		MobileCompanyNumber mobnumber=mobileNoRepository.save(mobileCompanyNumber);
			
		return new CustomerAppResponse<>(HttpStatus.OK.value(),
				"Provided mobile number details is successfully added by Admin",mobnumber
				);
	}
